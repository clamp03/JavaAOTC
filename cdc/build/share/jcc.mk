...
# AOTC - BY Clamp
CVM_JCC_INPUT += $(AOTC_BUILDTIME_CLASSESZIP)
##################
...
# AOTC - BY Clamp
CVM_JCC_OPTIONS += $(AOTC_BUILDTIME_CLASSES)
CVM_JCC_OPTIONS += $(AOTC_METHOD_ARGUEMENT_PASSING)
CVM_JCC_OPTIONS += $(AOTC_EXCEPTION_HANDLING)
#################
...
# AOTC - BY Clamp add aotc 7 directories &rm -f $(CVM_JCC_CLASSPATH)/aotc/*; line
...
$(CVM_JCC_DEPEND) :: $(CVM_JCC_SRCPATH)/JavaCodeCompact.java \
         ...
         $(CVM_JCC_SRCPATH)/aotc/*.java \
         $(CVM_JCC_SRCPATH)/aotc/share/*.java \
         $(CVM_JCC_SRCPATH)/aotc/translation/*.java \
         $(CVM_JCC_SRCPATH)/aotc/cfg/*.java \
         $(CVM_JCC_SRCPATH)/aotc/ir/*.java \
         $(CVM_JCC_SRCPATH)/aotc/optimizer/*.java \
         $(CVM_JCC_SRCPATH)/aotc/profile/*.java \
         $(CVM_JCC_SRCPATH)/JCCMessage.properties
	@echo "... $@"
	@CLASSPATH=$(CVM_JCC_CLASSPATH)$(PS)$(CVM_JCC_SRCPATH)$(PS)$(CVM_DERIVEDROOT)/javavm/runtime; export CLASSPATH; \
    rm -rf $(CVM_JCC_CLASSPATH)/aotc/*; \
	$(CVM_JAVAC) $(JAVAC_OPTIONS) -d $(CVM_JCC_CLASSPATH) \
	    $(CVM_JCC_CLASSES)
