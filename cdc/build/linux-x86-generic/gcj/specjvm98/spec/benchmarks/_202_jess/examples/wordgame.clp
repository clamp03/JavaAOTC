...
;;;     It runs in 45 seconds on herzberg under Jess; it works correctly, though
;;;======================================================
...
(defrule find-solution
  (combination D ?d)
  (combination T ?t&~?d&:(= (mod (+ ?d ?d) 10) ?t))
  (combination L ?l&~?d&~?t)
  (combination R ?r&~?d&~?t&~?l&:(= (mod (+ ?d ?d
                                            (* 10 ?l) (* 10 ?l))
                                         100)
                                    (+ (* 10 ?r) ?t)))
  (combination A ?a&~?d&~?t&~?l&~?r)
  (combination E ?e&~?d&~?t&~?l&~?r&~?a&:(= (mod (+ ?d ?d
                                                    (* 10 ?l) (* 10 ?l)
                                                    (* 100 ?a) (* 100 ?a))
                                                 1000)
                                            (+ (* 100 ?e) (* 10 ?r) ?t)))
  (combination N ?n&~?d&~?t&~?l&~?r&~?a&~?e)
  (combination B ?b&~?d&~?t&~?l&~?r&~?a&~?e&~?n&:(= (mod (+ ?d ?d
                                                            (* 10 ?l) (* 10 ?l)
                                                            (* 100 ?a) (* 100 ?a)
                                                            (* 1000 ?r) (* 1000 ?n))
                                                         10000)
  ...
  (combination G ?g&~?d&~?t&~?l&~?r&~?a&~?e&~?n&~?b&~?o&:(= (+ ?d ?d
                                                            (* 10 ?l) (* 10 ?l)
                                                            (* 100 ?a) (* 100 ?a)
                                                            (* 1000 ?r) (* 1000 ?n)
                                                            (* 10000 ?e) (* 10000 ?o)
