/*
 * Floating Point test
 * @(#)FloatingPointCheck.java	1.5 06/17/98
 *
...
$ java spec.benchmarks._200_check.FloatingPointCheck
FloatingPointCheck
        tiny:             1.0E-323
        tiny/small:       0.0
        (tiny/small)*big: 0.0
...
public class FloatingPointCheck {
    ...
    public static double doubleTiny = Double.MIN_VALUE + Double.MIN_VALUE;
    public static double doubleSmall = 8.0;
    public static double doubleBig = 256.0;
    public static double doubleHuge = Double.MAX_VALUE / 2.0;

    public static float floatTiny = Float.MIN_VALUE + Float.MIN_VALUE;
    public static float floatSmall = 8.0f;
    public static float floatBig = 256.0f;
    public static float floatHuge = Float.MAX_VALUE / 2.0f;

    public static double doubleOne = 1.0;
    public static double doubleEpsilon = Math.pow(2.0, -53.0);

    public static float floatOne = 1.0f;
    public static float floatEpsilon = (float) Math.pow(2.0, -24.0);
