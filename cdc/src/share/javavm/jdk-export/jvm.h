...
JNIEXPORT jboolean JNICALL
JVM_IsThreadAlive(CVMExecEnv *ee, jobject thread);
#elif defined(SERVER_AOTC_CNI)
int
JVM_IsThreadAlive(CVMExecEnv *ee, CVMStackVal32 *arguments);
#elif defined(SERVER_AOTC_MIX)
JNIEXPORT jboolean JNICALL
JVM_IsThreadAlive(CVMExecEnv *ee, CVMStackVal32 *arguments, int* ret, jobject thread);
#else
JNIEXPORT jboolean JNICALL
...
#if defined(SERVER_AOTC_JNI) || defined(SERVER_AOTC_WRAPPER)
JNIEXPORT jobjectArray JNICALL
JVM_GetClassSigners(CVMExecEnv *ee, jobject cls);
#elif defined(SERVER_AOTC_CNI)
int
JVM_GetClassSigners(CVMExecEnv *ee, CVMStackVal32 *arguments);
#elif defined(SERVER_AOTC_MIX)
JNIEXPORT jobjectArray JNICALL
JVM_GetClassSigners(CVMExecEnv *ee, CVMStackVal32 *arguments, int* ret, jobject cls);
#else
JNIEXPORT jobjectArray JNICALL
JVM_GetClassSigners(JNIEnv *env, jobject cls);
#endif
...
#if defined(SERVER_AOTC_JNI) || defined(SERVER_AOTC_WRAPPER)
JNIEXPORT void JNICALL
JVM_SetClassSigners(CVMExecEnv *ee, jobject cls, jobjectArray signers);
#elif defined(SERVER_AOTC_CNI)
int
JVM_SetClassSigners(CVMExecEnv *ee, CVMStackVal32 *arguments);
#elif defined(SERVER_AOTC_MIX)
JNIEXPORT void JNICALL
JVM_SetClassSigners(CVMExecEnv *ee, CVMStackVal32 *arguments, int* ret, jobject cls, jobjectArray signers);
#else
JNIEXPORT void JNICALL
JVM_SetClassSigners(JNIEnv *env, jobject cls, jobjectArray signers);
#endif
