...
interface CoreImageWriter {
    ...
    void    init( boolean uselinenumbers, boolean lossless, ClassnameFilterList nativeTypes, boolean verbose, int maxSegmentSize, boolean jitOn, boolean jniUpdate, boolean cvmAot/*jniUpdate&cvmAot arg added*/);
    // ************************************
