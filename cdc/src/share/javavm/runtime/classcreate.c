...
// Clamp
#ifdef SERVER_AOTC_WRAPPER 
        if((accessFlags & JVM_ACC_STATIC) == 0) {
            int i = 0;
            while(methodSig[i++] != ')') {};
            char t = methodSig[i];
            if(t == 'V') {
                mb->immutX.invokerAOT = (void*)&InvokeInterpreterV;
            }else if(t == 'L' || t == '[') {
                mb->immutX.invokerAOT = (void*)&InvokeInterpreterL;
            }else if(t == 'J') {
                mb->immutX.invokerAOT = (void*)&InvokeInterpreterJ;
            }else if(t == 'F') {
                mb->immutX.invokerAOT = (void*)&InvokeInterpreterF;
            }else if(t == 'D') {
                mb->immutX.invokerAOT = (void*)&InvokeInterpreterD;
            }else {
                mb->immutX.invokerAOT = (void*)&InvokeInterpreterI;
            }
        }
#endif
